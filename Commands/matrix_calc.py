...
# Define list of processed magnets:
        if self.tog1.isChecked():
             self.Magnets += MagnetLines['Matrix']
    ...
    def FindMatrices(self):
        ...
        os.system('elegant matrices.ele')
